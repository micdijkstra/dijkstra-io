...
const Field = styled.div`
  border-color: ${props => props.error ? props.theme.colors.errorOnDark : props.theme.colors.onDark};
  border-style: solid;
  border-width: 2px;
  color: ${props => props.error ? props.theme.colors.errorOnDark : props.theme.colors.onDark};
  line-height: 0;
  margin-bottom: ${props => props.theme.spacing.md};
  position: relative;
  ${props => props.error ? shake() : ''}
  ${placeholder(props => props.error ? props.theme.colors.errorOnDark : props.theme.colors.onDark)}
`
...
const TextArea = styled.textarea`
  ${placeholder(props => props.theme.colors.onDark)}
  background: none;
  border: 0;
  color: ${props => props.theme.colors.onDark};
  padding: ${props => props.theme.spacing.sm};
        ...
        <Collapsible collapse={formSubmitted}>
          ...
          >
            ...
            <Field error={fieldsWithErrors['name']}>
              <Input type="text" name="name" value={name} onChange={this.handleChange} onBlur={this.validateField} onKeyUp={this.clearValidation} placeholder="Your name" />
            </Field>
            <Field error={fieldsWithErrors['email']}>
              <Input type="email" name="email" value={email} onChange={this.handleChange} onBlur={this.validateField} onKeyUp={this.clearValidation} placeholder="Your email" />
            </Field>
            ...
            <Field error={fieldsWithErrors['message']}>
              <TextArea name="message" value={message} onChange={this.handleChange} onBlur={this.validateField} onKeyUp={this.validateField} placeholder="Project description" rows="5" />
            </Field>
            <Field>
